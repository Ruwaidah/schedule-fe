...
export default function LoginForm() {
    ...
    async function onSubmit(values) {
        console.log("Company login:", values);
            ...
            <Field label="Email" error={errors.email?.message}>
                <div className="relative">
                    ...
                    <input
                        ...
                        className={cn(
                            "w-full rounded-2xl border bg-white/90 px-10 py-3 text-sm text-slate-900 outline-none transition",
            ...
            <Field label="Password" error={errors.password?.message}>
                <div className="relative">
                    ...
                    <input
                        ...
                        className={cn(
                            "w-full rounded-2xl border bg-white/90 px-10 py-3 pr-12 text-sm text-slate-900 outline-none transition",
                            "placeholder:text-slate-400",
                            errors.password
                                ? "border-rose-300 ring-4 ring-rose-100"
                                : "border-slate-200/80 hover:border-slate-300 focus:border-blue-400 focus:ring-4 focus:ring-blue-200/50"
